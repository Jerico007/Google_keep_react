...
const NoteCard = ({noteData}) => {
  ...
  const [editedData,setEditData] = useState("")
    ...
    function saveNote(e){
        ...
        notesDispatch({type:"SAVE",payLoad:{id:id,title:editedData.title,content:editedData.content}});
        setEditData("");
    }
        ...
        <div className='NoteCard-container'>
            <div className='NoteCard-module' style={{backgroundColor:noteStyle.backgroundColor}}>
                ...
                <div className='NoteCard-button' >
                    {
                        noteData.edit? <Button onClick={saveNote} id={noteData.id} className={"NoteCard-save"} text={<SaveIcon id={noteData.id}  fontSize='small' sx={{color:"white"}}/>}></Button> :  <Button className={"NoteCard-edit"} onClick={editNote} id={noteData.id}  text={<EditIcon id={noteData.id}  fontSize='small' sx={{color:"white"}}/>}/>
                    }
                   
                    <Button className={"NoteCard-delete"} id={noteData.id} onClick={deleteNote} text={<DeleteIcon  id={noteData.id}  fontSize='small' sx={{color:"white"}}/>}/>
                    <div className='NoteCard-color-holder'>
                    <label htmlFor={`favcolor-${noteData.id}`} className='NoteCard-color-button'><ColorLensIcon fontSize='small' sx={{color:"white"}}/></label>
                    <Input id={`favcolor-${noteData.id}`} onChange={changeNoteColor} className={"NoteCard-color"} value={noteData.color}  type={"color"}/>
                    </div>
